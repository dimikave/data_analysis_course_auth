...
function [maximum,pr] = Group12Exe1Func1(countr,allData,period)
    ...
    if (period == 1)
        ...
        maximum = pr(1);    % Belgium peaks at Week 1 on period 1
    elseif (period == 0)
        ...
        c = bitand(c,d123456);
        pr = allData.positivity_rate(c==1);
        maximum = pr(4); % Belgium peaks at Week 4 on period 0
    end
end
